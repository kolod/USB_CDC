...
typedef struct _Device_cb
{
 ...
 /* Control Endpoints*/
  UsbStatus  (*Setup)            (struct _USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef  *req);
  uint8_t  (*EP0_TxSent)       (struct _USBD_HandleTypeDef *pdev );    
  UsbStatus  (*EP0_RxReady)      (struct _USBD_HandleTypeDef *pdev );
  /* Class Specific Endpoints*/
  UsbStatus  (*DataIn)           (struct _USBD_HandleTypeDef *pdev , uint8_t epnum);
  UsbStatus  (*DataOut)          (struct _USBD_HandleTypeDef *pdev , uint8_t epnum);
